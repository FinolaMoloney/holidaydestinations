  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        <h4 className="card-title">Hotels in New York City</h4>
        ...
        <br></br>
        <div className="row card-body">
        <h4 className="card-title">Hotels in Paris</h4>
          <div className="col-sm">
      ...
      <br></br>
      <div className="row card-body">
      <h4 className="card-title">Hotels in London</h4>
          <div className="col-sm">
      ...
      <br></br>
      <div className="row card-body">
      <h4 className="card-title">Hotels in Madrid</h4>
          <div className="col-sm">
      ...
      <br></br>
      <div className="row card-body">
      <h4 className="card-title">Hotels in Amsterdam</h4>
          <div className="col-sm">
